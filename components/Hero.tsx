    ...
    <section className="fixed top-0 left-0 h-screen w-full overflow-hidden flex flex-col items-center z-0">
      ...
      <div className="relative z-10 flex flex-col items-center pt-[150px] w-full px-4 text-center h-full pb-10">
        ...
        >
          ...
          <span className="text-foreground text-xs font-body font-medium pr-3">
        ...
        <motion.p
          ...
          className="mt-6 text-sm md:text-base text-foreground/70 font-body font-light leading-tight max-w-2xl"
        >
        ...
        >
          <button className="liquid-glass-strong rounded-full px-5 py-2.5 flex items-center gap-2 text-foreground font-body font-medium text-sm transition-transform hover:scale-105">
            Get Started
            <ArrowUpRight className="h-4 w-4" />
          </button>
          <button className="flex items-center gap-2 text-foreground font-body font-medium text-sm hover:opacity-80 transition-colors">
        ...
        <div className="mt-auto pb-8 pt-16 flex flex-col items-center">
          <div className="liquid-glass rounded-full px-4 py-1.5 mb-8 text-xs text-foreground/70 font-body">
            Trusted by the teams behind
          </div>
          <div className="flex flex-wrap justify-center gap-8 md:gap-16 text-2xl md:text-3xl font-heading italic text-foreground/80">
            <span>Stripe</span>
            <span>Vercel</span>
            <span>Linear</span>
            <span>Notion</span>
