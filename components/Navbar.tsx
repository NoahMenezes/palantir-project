  ...
  return (
    <nav className="fixed top-4 left-0 right-0 z-50 px-8 lg:px-16 py-3 flex items-center justify-between">
      ...
      <div className="hidden md:flex items-center liquid-glass rounded-full px-1.5 py-1 transition-all duration-300">
        ...
        <Link href="/events" className="px-3 py-2 text-sm font-medium text-white/90 font-body hover:text-white transition-colors">Events</Link>
      </div>
      ...
      <div className="flex items-center gap-6">
        ...
        <Show when="signed-in">
          <Link href="/dashboard" className="bg-white text-black rounded-full px-5 py-1.5 text-sm font-body font-bold flex items-center gap-1 hover:bg-white/90 transition-all cursor-pointer mr-4">
            Dashboard
